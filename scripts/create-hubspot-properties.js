...
const PROPERTIES_TO_CREATE = [
  ...
  // --- Event attendance status fields (James/Jai request — May 15) ---
  {
    name: 'workshop_attendance_status',
    label: 'Workshop Attendance Status',
    type: 'string',
    fieldType: 'text',
    groupName: 'contactinformation',
    description: 'Whether the contact attended the 3-day workshop (from GHL)',
    options: [],
  },
  {
    name: 'foundations_attendance_status',
    label: 'Foundations Attendance Status',
    type: 'string',
    fieldType: 'text',
    groupName: 'contactinformation',
    description: 'Whether the contact attended Foundations event (from GHL)',
    options: [],
  },
  {
    name: 'auction_attendance_status',
    label: 'Auction Attendance Status',
    type: 'string',
    fieldType: 'text',
    groupName: 'contactinformation',
    description: 'Whether the contact attended Auction Experience (from GHL)',
    options: [],
  },
  {
    name: 'commercial_attendance_status',
    label: 'Commercial Attendance Status',
    type: 'string',
    fieldType: 'text',
    groupName: 'contactinformation',
    description: 'Whether the contact attended Commercial event (from GHL)',
    options: [],
  },
  {
    name: 'expo_attendance_status',
    label: 'Expo Attendance Status',
    type: 'string',
    fieldType: 'text',
    groupName: 'contactinformation',
    description: 'Whether the contact attended Expo event (from GHL)',
    options: [],
  },
  {
    name: 'summit_attendance_status',
    label: 'Summit Attendance Status',
    type: 'string',
    fieldType: 'text',
    groupName: 'contactinformation',
    description: 'Whether the contact attended Real Estate Summit (from GHL)',
    options: [],
  },
  {
    name: 'symposium_attendance_status',
    label: 'Symposium Attendance Status',
    type: 'string',
    fieldType: 'text',
    groupName: 'contactinformation',
    description: 'Whether the contact attended Symposium event (from GHL)',
    options: [],
  },

  // --- Event date fulfilled fields (James/Jai request — May 15) ---
  {
    name: 'workshop_date_fulfilled',
    label: 'Workshop Date Fulfilled',
    type: 'date',
    fieldType: 'date',
    groupName: 'contactinformation',
    description: 'Date the 3-day workshop was fulfilled/attended',
    options: [],
  },
  {
    name: 'foundations_date_fulfilled',
    label: 'Foundations Date Fulfilled',
    type: 'date',
    fieldType: 'date',
    groupName: 'contactinformation',
    description: 'Date the Foundations/Wholesale Bootcamp was fulfilled',
    options: [],
  },
  {
    name: 'expo_bootcamp_date_fulfilled',
    label: 'Expo/Bootcamp Date Fulfilled',
    type: 'date',
    fieldType: 'date',
    groupName: 'contactinformation',
    description: 'Date the Tax Lien Expo/Asset Protection Bootcamp was fulfilled',
    options: [],
  },
  {
    name: 'auction_date_fulfilled',
    label: 'Auction Date Fulfilled',
    type: 'date',
    fieldType: 'date',
    groupName: 'contactinformation',
    description: 'Date the Auction Experience was fulfilled',
    options: [],
  },
  {
    name: 'commercial_bootcamp_date_fulfilled',
    label: 'Commercial Bootcamp Date Fulfilled',
    type: 'date',
    fieldType: 'date',
    groupName: 'contactinformation',
    description: 'Date the Commercial Bootcamp was fulfilled',
    options: [],
  },
  {
    name: 'flyout_date_fulfilled',
    label: 'Fly-Out Date Fulfilled',
    type: 'date',
    fieldType: 'date',
    groupName: 'contactinformation',
    description: 'Date the Fly-Out Mentorship was fulfilled',
    options: [],
  },
  {
    name: 'summit_date_fulfilled',
    label: 'Summit Date Fulfilled',
    type: 'date',
    fieldType: 'date',
    groupName: 'contactinformation',
    description: 'Date the Real Estate Summit was fulfilled',
    options: [],
  },
  {
    name: 'propstream_date_fulfilled',
    label: 'PropStream Date Fulfilled',
    type: 'date',
    fieldType: 'date',
    groupName: 'contactinformation',
    description: 'Date PropStream access was fulfilled',
    options: [],
  },
  ...
  // --- Events attended (multi-select) ---
  {
    ...
    label: 'TLC Events Attended',
    type: 'string',
    fieldType: 'text',
    groupName: 'contactinformation',
    description: 'Which TLC events the contact has attended (multi-value from GHL checkbox field)',
    options: [],
  },
];
